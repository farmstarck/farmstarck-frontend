...
const ViewProduct = () => {
  ...
  useEffect(() => {
    const filteredProduct = jsonProducts.find((p: ProductProps) => p.id === id);
  ...
  return (
    <div className="w-full  pt-24 px-5 md:pt-40">
      <div className="max-w-5xl m-auto flex flex-col gap-5">
        ...
        <div className="flex flex-col gap-10 items-center justify-between w-full md:flex-row">
          ...
          <div className="flex flex-col gap-3 w-full md:w-1/2">
            ...
            <div className="mt-3 flex gap-10 items-center">
              {/* details unit */}
              <div className="flex flex-col gap-2 w-1/2 sm:w-fit">
                <label className="text-gray-700 text-xs ">Unit</label>
                <div className="border border-secondary-light p-2 rounded flex gap-5 items-center justify-center ">
                  <span
                    onClick={handleDecrementUnit}
                    className="cursor-pointer w-4 h-4 bg-gray-500 text-white text-xs rounded flex items-center justify-center"
                  >
                    -
                  </span>
                  ...
                  <span
                    ...
                    className="cursor-pointer w-4 h-4 bg-secondary-dark text-white text-xs rounded flex items-center justify-center"
                  >
                    +
                  </span>
                </div>
              ...
              <div className="flex flex-col gap-2 w-1/2 sm:w-fit">
                ...
                <div className="bg-secondary-light sm:w-32 h-10 rounded flex gap-5 items-center justify-center ">
            ...
            <div className="flex  items-start gap-4 mt-3 md:mt-10  md:items-center">
              <button
                ...
                className=" px-2 py-2 flex justify-center items-center gap-2 bg-transparent text-secondary-dark capitalize font-medium text-btn-txt md:text-sm rounded-md border border-secondary-dark md:px-20 w-[100%] sm:w-fit sm:py-2"
              >
        ...
        <div className="bg-secondary-light rounded-md md:p-3">
          ...
          <button
            ...
            className="w-full flex justify-between items-center p-3 bg-transparent text-left focus:outline-none"
          >
            <span className="capitalize text-xs">Product Rating & Reviews</span>
            <span
              className={`transform transition-transform duration-300 ${
                  ...
                  return (
                    ...
                    >
                      <div>
                        ...
                        <YellowRating initialRating={review.rating} readonly />
                      </div>
                      <div>
